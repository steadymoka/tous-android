...
public class LodgmentFragment extends BaseFragment implements LodgmentFragmentLayoutListener {
	...
	private List<Spot> getDataFromDB() {
		...
		return SpotTable.from( getActivity() )
				.findSpotListOfPlanAndType( plan.getId(), DetailPlanFragment.TYPE_LODGMENT );
	}
	...
	@Override
	public void onClickToAddLodgment() {

		Intent intent = new Intent( getActivity(), SpotCreationActivity.class );
		intent.putExtra( SpotCreationActivity.KEY_SPOT_TYPE, DetailPlanFragment.TYPE_LODGMENT );
